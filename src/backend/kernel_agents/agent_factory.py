...
from kernel_agents.content_processing_agent import ContentProcessingAgent  # Add ContentProcessingAgent import
...
class AgentFactory:
    ...
    _agent_classes: Dict[AgentType, Type[BaseAgent]] = {
        ...
        AgentType.CONTENT_PROCESSING: ContentProcessingAgent,  # Add ContentProcessingAgent
    }
    ...
    _agent_type_strings: Dict[AgentType, str] = {
        ...
        AgentType.CONTENT_PROCESSING: AgentType.CONTENT_PROCESSING.value,
    }
    ...
    _agent_system_messages: Dict[AgentType, str] = {
        ...
        AgentType.CONTENT_PROCESSING: ContentProcessingAgent.default_system_message(),
    }
